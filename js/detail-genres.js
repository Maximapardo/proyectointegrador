window.addEventListener ('load', function (){
    ...
    for (let i = 0; i< arrayGenero.length; i++){
        DetalleGen += `<div class="series">
        <a href="./detail-serie.html?resultadosbusqueda=${arrayGenero[i].title}"><img src="https://image.tmdb.org/t/p/w500/${arrayGeneros[i].poster_path}" alt="series"></a>
        <h4 class="titulos-series">${arrayGenero[i].title}</h4>
        <p class="fechas">${arrayGenero[i].release_date}</p>
    </div>`
    }
